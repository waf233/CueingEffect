...
function 指导语RoutineBegin(snapshot) {
  return async function () {
    ...
    指导语Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function 刺激范围展示30RoutineBegin(snapshot) {
  return async function () {
    ...
    刺激范围展示30Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function interval_2RoutineBegin(snapshot) {
  return async function () {
    ...
    interval_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pre_cueRoutineBegin(snapshot) {
  return async function () {
    ...
    pre_cueComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
